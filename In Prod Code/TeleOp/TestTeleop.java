...
public class OpModeRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        /*
            Mwheel    [Motor0][Motor1]  Mwheel
                      [Motor2][Motor3]
            Mwheel    [Motor4][Motor5]  Mwheel
        */
        ...
        DcMotor MOTORNAME = hardwareMap.dcMotor.get("Motor2");
        DcMotor MOTORNAME = hardwareMap.dcMotor.get("Motor3");
        ...
        */
        ...
        //May need to change actual dive code for new motor design
        ...
        while (opModeIsActive()) {
            ...
            if(!(gamepad1.right_trigger > 0.1) && !(gamepad1.left_trigger > 0.1)) // Trigger Not pressed = Normal mode
            {
            ...
            else if((gamepad1.right_trigger > 0.1)) // Speed is increased when Right trigger pulled
            {
            ...
            else if((gamepad1.left_trigger > 0.1)) // Speed is Decreased when Left trigger pulled
            {
